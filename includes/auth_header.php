                ...
                <div class="col-lg-6">
                    <div class="header-top-left">
                        ...
                        <div class="header-contact">
                            <p><i class="ri-map-pin-fill"></i> Ilaro, Nigeria</p>
                        </div>
                        <div class="header-contact">
                            <a href="info@ecour-leanring.com"> <i class="ri-mail-send-line"></i> <span class="__cf_email__" data-cfemail="f69f989099b69395998384d895999b">info@ecour-leanring.com</span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="header-top-right">
                        ...
                        <a href="./courses" class="link style3"> Courses</a>
                        <span class="text-white">&nbsp;/&nbsp;</span>
                        <a href="./account" class="link style3"> Account</a>
                        <span class="text-white">&nbsp;/&nbsp;</span>
                        <a href="./logout" class="link style3"> Logout</a>
                    </div>
                </div>
